...
def underlined_text(text):
    return ("\033[2;37;40m%s \033[0;37;40m" %text)

def bright_colour(text):
    return ("\033[1;37;40m%s \033[0;37;40m" %text)

def negative_colour(text):
    return ("\033[3;37;40m%s \033[0;37;40m" %text)

#============= COLOURED TEXT ========================

def dark_gray(text):
    return ("\033[1;30;40m%s \033[0;37;40m" %text)
